...
const SLIDES = [
  {
    ...
    text: 'ГлобоАтлас отслеживает развитие по областям: Практическая жизнь, Сенсорика, Математика, Язык и Космос. Вы видите не оценки, а путь.',
  },
  {
    icon: '🎨',
    title: 'Что означают цвета',
    items: [
      { color: 'bg-gray-100 text-gray-400', label: '—', desc: 'Не начат — презентация еще не проводилась' },
      { color: 'bg-yellow-100 text-yellow-700', label: 'ЗН', desc: 'Знакомство — педагог провел презентацию' },
      { color: 'bg-blue-100 text-blue-700', label: 'ПВ', desc: 'Повторение — ребенок практикуется самостоятельно' },
