  ...
  parent: [
    {
      emoji: '📰',
      title: 'Лента группы',
      body: 'Здесь появляются фотографии и новости от педагогов. Лайкайте посты с вашим ребенком — педагогу важна обратная связь.',
    },
    {
      emoji: '🗺',
      title: 'Карта развития',
      body: 'Светофоры показывают прогресс по трем измерениям: Эмоции, Мышление, Тело. Тапните карточку — увидите все навыки и стадию каждого.',
    },
    {
      emoji: '💬',
      title: 'Чаты',
      body: 'Прямая связь с педагогом и специалистами. Сообщения видят только участники беседы — данные ребенка защищены.',
    },
    {
      emoji: '⚙️',
      title: 'Настройки',
      body: 'В настройках можно сменить пароль, скачать экспорт всех данных и удалить аккаунт. Согласие на обработку ПДн вы дали при активации.',
    },
  ],
  teacher: [
    {
    ...
    },
    {
      ...
      body: 'Записывайте короткие наблюдения по детям с фотографиями. AI поможет сформулировать развернутую запись из ваших ключевых слов.',
    },
    {
      emoji: '📰',
      title: 'Лента',
    ...
    },
    {
      emoji: '📋',
      title: 'Рекомендации',
      body: 'Выдавайте задания для дома — родителю придет уведомление. Привязывайте задание к конкретному навыку для точечного развития.',
    },
  ],
  psychologist: [
    { emoji: '👶', title: 'Дети', body: 'Список закрепленных за вами детей. По каждому — наблюдения, заметки, портфолио.' },
    { emoji: '📋', title: 'Рекомендации', body: 'Выдавайте задания родителям. Их можно отслеживать в режиме «выполнено / в процессе».' },
    { emoji: '📅', title: 'Слоты приема', body: 'Расписывайте окна для родительских встреч. Родитель бронирует через приложение.' },
  ],
  pediatrician: [
    { emoji: '👶', title: 'Дети', body: 'Список закрепленных детей с медицинскими пометками (аллергии, особенности).' },
    { emoji: '🩺', title: 'Назначения', body: 'Записывайте рекомендации, привязанные к ребенку. Видимость настраивается — только себе, с педагогом или родителю.' },
    { emoji: '📅', title: 'Слоты приема', body: 'Окна для приема — родитель сможет записаться через мобильное приложение.' },
  ],
};
