...
const DEFAULT_ABOUT: AboutContent = {
  intro:
    'Среда устроена так, чтобы ребенок мог сам выбирать материал, работать в своем темпе и осваивать навыки в естественной последовательности. Педагог — наблюдатель и проводник.',
  zones: [
    {
      n: '01',
    ...
    },
    {
      n: '03',
      title: 'Математика',
      desc: 'Конкретное → абстрактное. Веретена, числовые штанги, золотой материал, бусины.',
    ...
    },
    {
      n: '05',
      title: 'Космос',
      desc: 'Природа, география, история, биология. Ребенок учится понимать мир и свое место в нем.',
      accent: 'text-danger',
    },
  ],
  stages: [
