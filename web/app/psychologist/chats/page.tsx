...
const TYPE_LABEL: Record<string, string> = {
  teacher_psychologist: 'С педагогом',
  teacher_parent: 'С родителем',
  psychologist_parent: 'С родителем',
};
...
export default function PsychologistChats() {
  ...
  return (
    <PageLayout eyebrow="С педагогами и родителями" title="Чаты">
      {chats.length === 0 ? (
        <Card padding="md">
        ...
        <div className="space-y-2">
          {chats.map(chat => {
            ...
            return (
              <Link key={chat.id} href={`/psychologist/chats/${chat.id}`}>
