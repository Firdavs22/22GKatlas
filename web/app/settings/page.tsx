    ...
    <PageLayout eyebrow="Аккаунт" title="Настройки">
        ...
        <div className="flex items-center justify-between">
          <div className="max-w-2xl">
            ...
            <p className="text-sm text-slate-600">
              ...
              данные ребенка (для родителей), фото из ленты и портфолио, прогресс,
              наблюдения, посещаемость.
            </p>
          </div>
          <a
      ...
      <Card padding="md" className="border-danger/30">
        ...
        <p className="text-sm text-slate-600 mb-3 max-w-2xl">
          ...
          Прогресс ребенка, посещаемость, наблюдения педагога — останутся в системе
          {' '}(они не привязаны только к вашему аккаунту), но связь «родитель — ребенок» будет утеряна.
        </p>
