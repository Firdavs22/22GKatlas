...
— ФИО, возраст, фотографии ребенка
...
— Информирования родителей о развитии ребенка
— Организационных вопросов (расписание, мероприятия, оплата)

4. Кто имеет доступ
— Администрация сада: полный доступ
— Педагог: только дети своей группы
— Специалисты (психолог, педиатр): только закрепленные за ними дети
— Родители: только своих детей
— Третьи лица — НЕ ПЕРЕДАЕМ, кроме случаев, прямо предусмотренных законом

5. Срок хранения
Данные ребенка хранятся в течение всего периода обучения и 3 года после выпуска (для возможности восстановления). Затем — обезличиваются или удаляются.

6. Права пользователя
Любой родитель в любой момент может:
— Получить копию всех данных о своем ребенке (раздел «Настройки» → «Экспорт»)
