...
const TAGS: Record<Props['role'], string[]> = {
  psychologist: ['Важно', 'Дом. практика', 'Эмоции'],
  pediatrician: ['Важно', 'Вакцинация', 'Питание'],
};

export default function SpecialistRecommendationsScreen({ role }: Props) {
  ...
  return (
    <>
      ...
      <MobileShell eyebrow="Для родителей" title="Рекомендации">
